    ...
    <div className="home w-full px-0 lg:px-10 pb-20 2xl:px-40 bg-bgColor lg:rounded-lg h-screen overflow-hidden">
      ...
      <div className="w-full flex gap-2 lg:gap-4 pt-5 pb-10 h-full">
        ...
        <div className="flex-1 h-full bg-primary px-4 flex flex-col gap-6 overflow-y-auto rounded-lg">
          ...
          >
            <div className="w-full flex items-center gap-2 py-4 border-b order-[#66666645]">
              <img
              ...
              <TextInput
                ...
                register={register("description", {
                  required: "Write something about this post",
                })}
                ...
                >
                  ...
                  <div className="flex gap-1">
                    <button
                      ...
                      onClick={() => {}}
                    >
                      <BsPersonFillAdd size={20} className="text-[#0752b6]" />
                    </button>
                  </div>
                </div>
              ))}
